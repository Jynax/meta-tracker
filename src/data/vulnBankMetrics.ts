...
export const vbDerived: DerivedMetric[] = [
  ...
  { label: 'Decisions', value: '5', detail: 'Workflow (2) + Coordination (3)', color: '#8b5cf6' },
  { label: 'Sessions', value: '4', detail: 'All Spec phase so far', color: '#f59e0b' },
  { label: 'PRs Created', value: '5', detail: '3 Claude Code + 1 Cursor + 1 shared', color: '#10b981' },
];
