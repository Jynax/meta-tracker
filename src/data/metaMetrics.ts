...
export const metaSessions: SessionEntry[] = [
  ...
  { session: 'Session 16', date: 'Mar 4', label: 'Codebase Audit', duration: 3, prs: 8, decisions: 2, deadEnds: 0, focus: 'Codebase audit + bug fixes, process overhaul (START HERE, STATUS.md, task folders), file decomposition (ProcessWorkflow + MetricsDashboard split)', chapterId: 'meta-ch-process-overhaul', workCategory: 'Tooling' },
