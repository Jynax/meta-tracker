...
export const vbBugs: BugEntry[] = [
  { id: 21, session: 'Session 8', date: 'Mar 10', label: 'Commando-X References', summary: 'README, openapi.json, and index.html still referenced Commando-X/vuln-bank instead of redacted/vuln-bank', severity: 'Medium', source: 'Codebase audit', status: 'Fixed (PR #53)', category: 'Technical' },
