...
export const metaSessions: SessionEntry[] = [
  ...
  { session: 'Session 44', date: 'Mar 12', label: 'T-1–T-4 Data Migration', duration: 3, prs: 4, decisions: 1, deadEnds: 0, focus: 'Full Day/Block data migration: T-1 type definitions + Easter egg (PR #96), T-2 migration script 84 sessions→42 days (PR #98), T-3 Sessions tab Day/Block UI (PR #99), T-4 Decision tree date anchoring with 192 nodes tagged (PR #100). All 81 Playwright tests pass.', chapterId: 'meta-ch-time-machine-data-model', workCategory: 'Refactor', tool: 'Claude Code', taskCount: 4, phase: 'Review', driver: 'agent-led', prDetails: [
...
export const metaDays: DayEntry[] = [
  {
    ...
    metrics: { totalTimeMinutes: 540, linesAdded: 1092, linesDeleted: 155, totalDecisions: 14 },
  ...
  },
  {
    ...
    metrics: { totalTimeMinutes: 480, linesAdded: 1539, linesDeleted: 633, totalDecisions: 12 },
  ...
  },
  {
    ...
    metrics: { totalTimeMinutes: 360, linesAdded: 873, linesDeleted: 430, totalDecisions: 12 },
  ...
  },
  {
    ...
    metrics: { totalTimeMinutes: 720, linesAdded: 2883, linesDeleted: 581, totalDecisions: 15 },
  ...
  },
  {
    ...
    metrics: { totalTimeMinutes: 540, linesAdded: 511, linesDeleted: 659, totalDecisions: 5 },
  ...
  },
  {
    ...
    metrics: { totalTimeMinutes: 660, linesAdded: 1687, linesDeleted: 1283, totalDecisions: 5 },
    driverSummary: { human: 0, ai: 4, collaborative: 1 },
  },
  {
    date: 'Mar 6',
    ...
    metrics: { totalTimeMinutes: 300, linesAdded: 530, linesDeleted: 106, totalDecisions: 1 },
    driverSummary: { human: 0, ai: 4, collaborative: 0 },
  },
  {
    date: 'Mar 8',
  ...
  },
  {
    ...
    metrics: { totalTimeMinutes: 120, linesAdded: 646, linesDeleted: 34, totalDecisions: 2 },
    driverSummary: { human: 0, ai: 1, collaborative: 0 },
  },
  {
    date: 'Mar 10',
    ...
    metrics: { totalTimeMinutes: 240, linesAdded: 1162, linesDeleted: 62, totalDecisions: 1 },
    driverSummary: { human: 0, ai: 3, collaborative: 0 },
  },
  {
    date: 'Mar 11',
    ...
    metrics: { totalTimeMinutes: 180, linesAdded: 233, linesDeleted: 17, totalDecisions: 0 },
