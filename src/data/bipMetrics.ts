...
export const bipCodeVolume: CodeVolumeEntry[] = [
  ...
  { session: 'ChatGPT 5', date: 'Feb 18', label: 'Deployment & Auth', added: 45, deleted: 0, net: 45, total: 3111 },
  { session: 'Cowork 1', date: 'Feb 21', label: 'Audit', added: 0, deleted: 0, net: 0, total: 3111 },
  { session: 'Cowork 2', date: 'Feb 22', label: 'Data Wrangling', added: 275, deleted: 8, net: 267, total: 3378 },
  { session: 'Cowork 3', date: 'Feb 25', label: 'Decomposition', added: 136, deleted: 570, net: -434, total: 2944 },
  { session: 'Cowork 4', date: 'Feb 26', label: 'Timeline', added: 173, deleted: 38, net: 135, total: 3079 },
  { session: 'Cowork 13', date: 'Mar 4', label: 'Deep Decomposition', added: 1797, deleted: 1380, net: 417, total: 3496 },
  { session: 'Claude Code 2', date: 'Mar 5', label: 'State Extraction', added: 1470, deleted: 1124, net: 346, total: 3842 },
  { session: 'Claude Code 4', date: 'Mar 5', label: 'Messy Ingestion', added: 277, deleted: 0, net: 277, total: 4119 },
  { session: 'Claude Code 4', date: 'Mar 5', label: 'Bug Fixes #08-10', added: 51, deleted: 52, net: -1, total: 4118 },
...
export const bipSessions: SessionEntry[] = [
  // ChatGPT sessions verified via export audit (Task #49, Mar 10 2026)
  {
    session: 'ChatGPT 1',
    date: 'Feb 14',
    ...
    chapterId: 'bip-spark',
    workCategory: 'Feature', tool: 'Mixed', taskCount: 1,
    phase: 'Build',
  ...
  },
  {
    ...
    chapterId: 'bip-spark',
    workCategory: 'Refactor', tool: 'Mixed', taskCount: 1,
    phase: 'Build',
    driver: 'collaborative',
  },
  {
  ...
  },
  {
    session: 'ChatGPT 5',
    date: 'Feb 18',
    label: 'Deployment & Auth',
    duration: 3,
    prs: 0,
    decisions: 4,
    deadEnds: 1,
    focus: 'Cloudflare Pages Deploy, Workers Auth, Domain Setup',
    chapterId: 'bip-deploy',
    workCategory: 'Tooling', tool: 'Mixed', taskCount: 1,
    phase: 'Build',
    driver: 'collaborative',
  },
  {
