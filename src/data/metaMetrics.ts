...
export const metaSessions: SessionEntry[] = [
  ...
  { session: 'Session 1', date: 'Feb 26', label: 'Scaffold & Auth', duration: 3, prs: 4, decisions: 2, deadEnds: 0, focus: 'Scaffold, deploy, auth setup', chapterId: 'meta-ch-inception', workCategory: 'Feature', tool: 'Cowork', taskCount: 4, phase: 'Build', driver: 'agent-led' },
  { session: 'Session 2', date: 'Feb 26', label: 'Vertical Tree', duration: 2, prs: 2, decisions: 2, deadEnds: 0, focus: 'Vertical tree exploration', chapterId: 'meta-ch-horizontal', workCategory: 'Feature', tool: 'Cowork', taskCount: 2, phase: 'Build', driver: 'agent-led' },
  { session: 'Session 3', date: 'Feb 26', label: 'React Flow Rebuild', duration: 3, prs: 4, decisions: 2, deadEnds: 1, focus: 'React Flow rebuild', chapterId: 'meta-ch-horizontal', workCategory: 'Refactor', tool: 'Cowork', taskCount: 4, phase: 'Build', driver: 'agent-led' },
  ...
  { session: 'Session 5', date: 'Feb 28', label: 'Layout Refactor', duration: 3, prs: 4, decisions: 2, deadEnds: 2, focus: 'Vertical layout, spacing tuning', chapterId: 'meta-ch-spacing-wars', workCategory: 'Refactor', tool: 'Cowork', taskCount: 4, phase: 'Build', driver: 'agent-led' },
  { session: 'Session 7', date: 'Feb 28', label: 'Data Model Alignment', duration: 3, prs: 5, decisions: 5, deadEnds: 0, focus: 'Type system, multi-project, alternating layout', chapterId: 'meta-ch-data-alignment', workCategory: 'Refactor', tool: 'Cowork', taskCount: 5, phase: 'Build', driver: 'agent-led' },
  { session: 'Session 8', date: 'Mar 2', label: 'Spine Fix & Dashboard', duration: 3, prs: 4, decisions: 5, deadEnds: 0, focus: 'Spine fix, dashboard infrastructure', chapterId: 'meta-ch-spine-dashboard', workCategory: 'Bug', tool: 'Cowork', taskCount: 4, phase: 'Build', driver: 'agent-led' },
  { session: 'Session 9', date: 'Mar 2', label: 'UX Polish', duration: 2, prs: 5, decisions: 4, deadEnds: 0, focus: 'Dashboard UX Polish', chapterId: 'meta-ch-ux-polish', workCategory: 'Feature', tool: 'Cowork', taskCount: 5, phase: 'Review', driver: 'agent-led' },
  ...
  { session: 'Session 12', date: 'Mar 3', label: 'Dashboard Data Overhaul', duration: 3, prs: 8, decisions: 2, deadEnds: 0, focus: 'Wire Remnants, date-grouped charts, code review + 4 bugs found/fixed', chapterId: 'meta-ch-dashboard-data-overhaul', workCategory: 'Refactor', tool: 'Cowork', taskCount: 4, phase: 'Build', driver: 'agent-led' },
  { session: 'Session 13', date: 'Mar 3', label: 'Stacked Tree View', duration: 3, prs: 6, decisions: 2, deadEnds: 0, focus: 'StackedTreeView component, stacked/canvas toggle, parity polish', chapterId: 'meta-ch-stacked-tree-view', workCategory: 'Feature', tool: 'Cowork', taskCount: 3, phase: 'Build', driver: 'agent-led' },
  { session: 'Session 14', date: 'Mar 3', label: 'UX Final Pass', duration: 3, prs: 5, decisions: 5, deadEnds: 0, focus: 'UX Final Pass: fonts, layout, charts, scalability', chapterId: 'meta-ch-ux-final-pass', workCategory: 'Feature', tool: 'Cowork', taskCount: 3, phase: 'Review', driver: 'agent-led' },
...
export const metaDays: DayEntry[] = [
  {
    ...
    blocks: [
      ...
      { id: 'meta-session-8', dayId: 'Mar 2', label: 'Spine Fix & Dashboard', workCategory: 'Bug', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 180, linesAdded: 650, linesDeleted: 41, note: 'Spine fix, dashboard infrastructure', contextWindowOrigin: false },
      { id: 'meta-session-9', dayId: 'Mar 2', label: 'UX Polish', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 120, linesAdded: 432, linesDeleted: 104, note: 'Dashboard UX Polish', contextWindowOrigin: false },
      { id: 'meta-session-10', dayId: 'Mar 2', label: 'Data Verification', workCategory: 'Bug', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 60, linesAdded: 10, linesDeleted: 10, note: 'Data verification & fixes via GitHub API', contextWindowOrigin: false },
  ...
  },
  {
    ...
    chapterId: 'meta-ch-inception',
    blocks: [
      { id: 'meta-session-1', dayId: 'Feb 26', label: 'Scaffold & Auth', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 180, linesAdded: 862, linesDeleted: 6, note: 'Scaffold, deploy, auth setup', contextWindowOrigin: false },
      { id: 'meta-session-2', dayId: 'Feb 26', label: 'Vertical Tree', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 120, linesAdded: 239, linesDeleted: 265, note: 'Vertical tree exploration', contextWindowOrigin: false },
      { id: 'meta-session-3', dayId: 'Feb 26', label: 'React Flow Rebuild', workCategory: 'Refactor', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 180, linesAdded: 438, linesDeleted: 362, note: 'React Flow rebuild', contextWindowOrigin: false },
    ],
  ...
  },
  {
    ...
    blocks: [
      { id: 'meta-session-4', dayId: 'Feb 27', label: 'Overlap & Filters', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 120, linesAdded: 157, linesDeleted: 37, note: 'Overlap fix, category filter', contextWindowOrigin: false },
    ],
  ...
  },
  {
    ...
    blocks: [
      { id: 'meta-session-5', dayId: 'Feb 28', label: 'Layout Refactor', workCategory: 'Refactor', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 180, linesAdded: 202, linesDeleted: 141, note: 'Vertical layout, spacing tuning', contextWindowOrigin: false },
      { id: 'meta-session-7', dayId: 'Feb 28', label: 'Data Model Alignment', workCategory: 'Refactor', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 180, linesAdded: 671, linesDeleted: 289, note: 'Type system, multi-project, alternating layout', contextWindowOrigin: false },
    ],
  ...
  },
  {
    ...
    blocks: [
      { id: 'meta-session-12', dayId: 'Mar 3', label: 'Dashboard Data Overhaul', workCategory: 'Refactor', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 180, linesAdded: 515, linesDeleted: 117, note: 'Wire Remnants, date-grouped charts, code review + 4 bugs found/fixed', contextWindowOrigin: false },
      { id: 'meta-session-13', dayId: 'Mar 3', label: 'Stacked Tree View', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 180, linesAdded: 714, linesDeleted: 74, note: 'StackedTreeView component, stacked/canvas toggle, parity polish', contextWindowOrigin: false },
      { id: 'meta-session-14', dayId: 'Mar 3', label: 'UX Final Pass', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 180, linesAdded: 587, linesDeleted: 385, note: 'UX Final Pass: fonts, layout, charts, scalability', contextWindowOrigin: false },
      { id: 'meta-session-15', dayId: 'Mar 3', label: 'How We Work View', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 180, linesAdded: 1067, linesDeleted: 5, note: 'How We Work view: ProcessWorkflow component + view switcher wiring', contextWindowOrigin: false },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 'meta-session-17', dayId: 'Mar 4', label: 'Mojibake Fix', workCategory: 'Bug', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 60, linesAdded: 53, linesDeleted: 53, note: 'Fixed 53 triple-encoded UTF-8 mojibake across 6 files. Iterative decoder, 6 API commits.', contextWindowOrigin: false },
      { id: 'meta-session-18', dayId: 'Mar 4', label: 'How We Work Content', workCategory: 'Tooling', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 60, linesAdded: 20, linesDeleted: 20, note: 'Updated ProcessWorkflow.tsx for task-based workflow. 1 API commit.', contextWindowOrigin: false },
      { id: 'meta-session-19', dayId: 'Mar 4', label: 'Date-Based Labels', workCategory: 'Refactor', driver: 'agent-led', operator: 'claude-ai', timeMinutes: 120, linesAdded: 218, linesDeleted: 509, note: 'Replaced session-number labels with date + descriptor format across all views. 2 API commits.', contextWindowOrigin: false },
      { id: 'meta-session-20', dayId: 'Mar 4', label: 'Bugs + UX Batch', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-code', timeMinutes: 120, linesAdded: 125, linesDeleted: 35, note: '5 tasks via Claude Code CLI: workCategory data, Work Mix chart, Bugs table overhaul, donut polish, reverse chron order.', contextWindowOrigin: false },
    ],
    metrics: { totalTimeMinutes: 540, linesAdded: 511, linesDeleted: 659, totalDecisions: 7 },
    driverSummary: { human: 0, ai: 4, collaborative: 1 },
  },
  {
    date: 'Mar 5',
    projectId: 'meta',
    ...
    blocks: [
      ...
      { id: 'meta-session-23', dayId: 'Mar 5', label: 'How We Work Rewrite + UX', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-code', timeMinutes: 120, linesAdded: 128, linesDeleted: 141, note: '5 tasks via Claude Code: How We Work rewrite (Cowork→Claude Code), Lucide icons, stacked tree collapse/multi-open, pills visual-only, reverse chron audit.', contextWindowOrigin: false },
      ...
      { id: 'meta-session-25', dayId: 'Mar 5', label: 'Chart Scaling + Tool Tracking', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-code', timeMinutes: 120, linesAdded: 245, linesDeleted: 50, note: 'Chart scaling (milestone labels, weekly toggle) and session tool tracking (tool field, badges, Avg Task Time chart). PRs #57-58.', contextWindowOrigin: false },
      { id: 'meta-session-26', dayId: 'Mar 5', label: 'Bugs + UX Batch 2', workCategory: 'Bug', driver: 'agent-led', operator: 'claude-code', timeMinutes: 120, linesAdded: 77, linesDeleted: 55, note: '5 tasks batched: fix weekly chart grouping, remove Dead Ends line, donut layout overhaul, default project, live app links. Follow-up fix for chart grouping and per-tool lines. PRs #59-60.', contextWindowOrigin: false },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 'meta-session-28', dayId: 'Mar 6', label: 'SC Theme Toggle', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-code', timeMinutes: 60, linesAdded: 199, linesDeleted: 68, note: 'CSS custom properties theme system, SC dark theme toggle. 3 new files, 7 modified. PR #66.', contextWindowOrigin: false },
      ...
      { id: 'meta-session-30', dayId: 'Mar 6', label: 'Time Machine + Bugfixes', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-code', timeMinutes: 120, linesAdded: 306, linesDeleted: 25, note: 'Time Machine toggle on History tab (Task #10, PR #70). Fix category bar + parent date bar regressions from SC theme (Task #43, PR #71).', contextWindowOrigin: false },
    ],
  ...
  },
  {
    ...
    chapterId: 'meta-ch-process-overhaul',
    blocks: [
      { id: 'meta-session-31', dayId: 'Mar 8', label: 'Data Model + New Projects', workCategory: 'Data', driver: 'agent-led', operator: 'claude-code', timeMinutes: 60, linesAdded: 406, linesDeleted: 45, note: 'Phase 1 data model extension (projectType, currentPhase, phase, driver, operator, expanded workCategory). Phase 2: Item-B-Gone + Vuln Bank projects added. PRs #75-77.', contextWindowOrigin: false },
    ],
  ...
  },
  {
    ...
    chapterId: 'meta-ch-process-overhaul',
    blocks: [
      { id: 'meta-session-32', dayId: 'Mar 9', label: 'Batch Update + Phase 3', workCategory: 'Feature', driver: 'agent-led', operator: 'claude-code', timeMinutes: 120, linesAdded: 646, linesDeleted: 34, note: 'Designer credit, planning session backfill, metrics crash fix (Bug #31), decision tree updates + SC Easter egg, Phase 3 cross-project visuals. PRs #78-81.', contextWindowOrigin: false },
    ],
